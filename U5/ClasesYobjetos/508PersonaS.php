...
class Empleado extends Persona {
    ...
    public function __toString(): string {
        $telefonosStr = empty($this->telefonos) ? "Sin teléfonos" : implode(", ", $this->telefonos);
        return parent::__toString() . ", Sueldo: {$this->sueldo}, Teléfonos: {$telefonosStr}, Sueldo Tope: " . self::$sueldoTope;
    }
}

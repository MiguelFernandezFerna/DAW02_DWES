<?php
    ...
    try {
        $sql = "update proyecto set titulo = :titulo, descripcion = :descripcion, periodo = :periodo, curso = :curso, fecha_presentacion = :fecha_presentacion, nota = :nota, modulo1 = :modulo1, modulo2 = :modulo2, modulo3 = :modulo3, alumno = :alumno, tutor = :tutor where id_proyecto = :id_proyecto";
